...
const WindowRepresentation: React.FC<IWindowRepresentationProps> = ({ className, children }) => {
  return (
    <div className={`relative row-start-1 col-start-6 xl:col-start-7 col-span-7 xl:col-span-6 z-10 ${className ?? ""}`}>
      <div className="-mx-4 mx-0 md:min-h-[20rem] md:min-w-[35rem]">
...
export default WindowRepresentation;