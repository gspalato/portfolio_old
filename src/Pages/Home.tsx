		...
		<React.Fragment>
            ...
            <ContentContainer>
				<Section display="flex" direction="column" justify="center" align="center">
					<MainTitleContainer>
						<Paragraph style={{ fontFamily: 'Inter', fontSize: '1.5vw', fontWeight: 100 }}>
							Hello, 👋
						</Paragraph>
						...
						<TypewritterParagraph>
    						...
    						{[
								...
								<Typist>
									...
									<Typist.Backspace count={text.length} delay={text.length * 20} />
								</Typist>
							)}
							</TypistLoop>
						</TypewritterParagraph>
					</MainTitleContainer>
					{/* presenceActive ? 'block' : 'none' */}
