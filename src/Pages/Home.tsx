...
import ProfilePicture from "../Assets/img/selfie_variant.png";
	...
	return (
		<Page>
			<div className="bg-transparent">
				...
				<section className="relative flex flex-col items-center justify-center h-screen max-w-screen-xl pl-5 pr-5 mx-auto">
					<div className="absolute w-full h-full">
						<img src={ColorBrush1} className="hidden w-full h-full pt-12 md:block" draggable="false" />
					</div>
					<motion.div
